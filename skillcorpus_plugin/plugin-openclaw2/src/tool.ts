...
import type { AgentTool, PluginLogger, ToolExecuteContext, ToolResult } from './openclaw2-types.js'
...
const DESCRIPTION = [
  ...
  'and files it needs. Reach for this before improvising a multi-step',
  'procedure, and when a task names a format, tool, or workflow you would',
