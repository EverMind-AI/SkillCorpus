...
Usage:
    GITHUB_TOKEN=ghp_xxx python3 -m skillcorpus.license_audit refresh
    python3 -m skillcorpus.license_audit build
    python3 -m skillcorpus.license_audit validate
    python3 -m skillcorpus.license_audit apply --dry-run
    python3 -m skillcorpus.license_audit stats
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m skillcorpus.license_audit",
